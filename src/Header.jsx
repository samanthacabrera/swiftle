        ...
        <>
            <div className="flex items-center w-screen h-[10vh] text-white bg-pink-500 font-bold relative">
                <div className="flex flex-col md:flex-row md:items-center space-y-1 md:space-x-6 ml-4 tracking-widest">
                    <h1 className="text-4xl font-medium">Swiftle</h1>
                    <h6 className="text-xs md:text-lg font-thin">A game inspired by a love of Taylor Swift & NYT's <a href="https://www.nytimes.com/games/connections" target="_blank" className="hover:border-b">Connections</a></h6>
                </div>
